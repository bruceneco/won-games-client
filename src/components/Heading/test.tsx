...
describe('<Heading />', () => {
  ...
  it('should render a heading with smaller font', () => {
    renderWithTheme(<Heading size="small">Won Games</Heading>)
    const component = screen.getByRole('heading', { name: /won games/i })
    expect(component).toHaveStyle({
      fontSize: '1.6rem'
    })
    expect(component).toHaveStyleRule('width', '3rem', { modifier: '::after' })
  })
  it('should render a heading with a primary line color', function () {
    renderWithTheme(
